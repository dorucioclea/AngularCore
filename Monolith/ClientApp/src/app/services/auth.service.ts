...
export class AuthService {
  ...
  public promoteToAdmin(userId) {
    ...
    return this.http.post(this.authUrl + "/promote", JSON.stringify(userId), this.httpOptions);
  }

  public degradeFromAdmin(userId) {
    return this.http.post(this.authUrl + "/degrade", JSON.stringify(userId), this.httpOptions);
  }
